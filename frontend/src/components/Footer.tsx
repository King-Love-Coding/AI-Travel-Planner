      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">VoyageSync</span>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              Plan unforgettable trips with friends. Collaborate, share expenses, and create memories together with our all-in-one travel planning platform.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 VoyageSync. All rights reserved.
          </p>
